...
- 신청 문서 준비: 기업마당·과기정통부 공식 첨부에서 신청 문항을 찾고, AI와 정리한 입력을 사용자가 확인해 저장
...
- 관심 공고·대화 기록: 로그인 계정별 저장·다시 보기·삭제, 비회원 검색 결과의 로그인 후 복원
- 계정·기업 프로필: 이메일 회원가입·카카오/Google 로그인, 비밀번호 관리, 사업자 조회·기업 등록과 협업 정보 관리
- 관리자 회원·기업 관리: 계정 검색·상세 조회, 정지·정지 해제와 강제 로그아웃

소셜 로그인·정기 메일은 별도 연동 설정이 필요하며, 신청 문서의 완성본 자동 생성은 아직 지원하지 않습니다.
