...
enum class ReviewRunFailureCode {
    SOURCE_UNSUPPORTED, SOURCE_NOT_FOUND, SOURCE_UNAVAILABLE, SOURCE_INVALID, SOURCE_TOO_LARGE,
    ANALYSIS_UNAVAILABLE, ANALYSIS_INVALID, RUN_FAILED, RUN_CAPACITY_EXCEEDED, RUN_RATE_LIMITED,
}
