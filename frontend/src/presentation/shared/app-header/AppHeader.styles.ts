...
export const appHeaderStyles = {
  ...
  header: classes(
    ...
    'rounded-[2rem] bg-[#102b22] text-white shadow-[0_12px_30px_rgb(16_43_34_/_8%)]',
    'max-chat:grid-cols-[minmax(0,1fr)_auto] max-chat:gap-y-2',
    'px-[clamp(0.75rem,3vw,1.5rem)] py-4',
  ),
  currentPage: 'm-0 whitespace-nowrap text-center text-[0.95rem] font-extrabold tracking-[-0.02em] text-[#e2f1e9] max-chat:text-[0.85rem]',
  brand: 'flex min-w-0 items-center gap-2.5 justify-self-start text-white no-underline',
  brandMark:
    'grid size-9 shrink-0 place-items-center rounded-full bg-brand-accent text-[1.1rem] font-black text-[#102b22]',
  brandTitle: 'block text-[1.05rem] font-extrabold tracking-[-0.04em]',
  brandSubtitle: 'mt-[0.1rem] block text-[0.7rem] text-[#b4cdbf] max-chat:hidden',
  ...
  navLink: classes(
    ...
    'border-[#3b5d4c] bg-[#19392c] text-[#e2f1e9] hover:bg-[#286044] hover:text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#b9e5ce]',
    'max-chat:px-[0.6rem] max-chat:text-[0.66rem]',
  ),
  loginButton: classes(
    'whitespace-nowrap rounded-full border-0 bg-white px-[0.9rem] py-[0.5rem] text-[0.74rem] font-extrabold text-[#102b22] no-underline',
    'hover:bg-[#e2f1e9] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#b9e5ce] max-chat:px-[0.7rem] max-chat:text-[0.66rem]',
  ),
} as const
