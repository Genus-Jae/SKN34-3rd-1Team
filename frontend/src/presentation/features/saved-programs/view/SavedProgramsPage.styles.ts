...
export const savedCalendarStyles = {
  ...
  header: 'shrink-0 px-6 pt-7 pb-5 max-chat:px-4',
  heading: 'm-0 text-[1.7rem] font-extrabold tracking-tight',
  intro: 'mt-2 mb-0 text-sm leading-relaxed text-sample-muted',
  preview: 'rounded-full bg-brand-accent px-3 py-1 text-xs font-semibold text-brand-primary',
  content: 'flex min-h-0 flex-1 flex-col px-6 pb-6 max-chat:px-4',
  ...
  today: `cursor-pointer rounded-md border border-sample-border bg-white px-4 py-2 text-sm font-medium text-app-ink hover:border-brand-primary hover:text-brand-primary ${focus}`,
