...
export const companyProfileStyles = {
  ...
  completionHint: 'text-[0.75rem] leading-[1.5] text-[#7883a3]',
  fieldGrid: 'grid grid-cols-2 gap-3 max-chat:grid-cols-1',
  ...
  fieldLabel: 'flex items-center gap-1 text-[0.7rem] font-bold text-[#7883a3]',
  optionalMark: 'font-medium text-[#a0a8bd]',
  fieldValue: 'flex items-center gap-2 text-[0.85rem] text-[#293454]',
  emptyValue: 'text-[0.85rem] text-[#a0a8bd]',
  ...
  settingDescription: 'mt-[0.1rem] block text-[0.74rem] leading-[1.5] text-[#7883a3]',
  choiceColumns: 'grid grid-cols-2 gap-4 max-chat:grid-cols-1',
  ...
  capabilityHint: 'text-[0.72rem] leading-[1.5] text-[#7a849d]',
  statusRow:
  ...
  accountLabel: 'block text-[0.7rem] font-bold text-[#7883a3]',
  ...
  publicClosed: 'border-t border-[#e4e9f7] px-[0.7rem] py-[0.55rem] text-[#7a849d]',
  checklist: 'flex flex-col gap-[0.45rem] text-[0.8rem]',
  checklistItem: 'flex items-center gap-[0.55rem]',
