...
export const supportProgramDetailStyles = {
  ...
  questionSection: 'mt-6 rounded-3xl border border-[#dfe4f2] bg-white p-[clamp(1.4rem,4vw,2.1rem)]',
  questionDescription: 'mt-3 mb-0 leading-[1.6] text-[#536087]',
  questionLink: classes(
    'mt-5 inline-flex rounded-[0.7rem] bg-brand-primary px-4 py-3 text-[0.84rem] font-extrabold text-white no-underline',
    'hover:bg-[#4d4dab]',
  ),
