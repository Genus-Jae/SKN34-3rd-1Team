...
const formControl = classes(
  ...
  'border-[#dbe9e0] bg-white text-[#15271f]',
  'focus:border-[#147d58] focus:[outline:3px_solid_rgb(20_125_88_/_12%)]',
)
...
export const sampleItemStyles = {
  ...
  backButton: classes(
    ...
    'border border-[#dbe9e0] bg-white px-[0.85rem] py-[0.65rem]',
    'text-[0.85rem] font-bold text-[#365947] no-underline hover:border-[#147d58] hover:bg-[#f0f9f3] hover:text-[#106b48] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#147d58]',
  ),
  hero:
    'mb-8 grid grid-cols-[minmax(0,1fr)_minmax(280px,360px)] items-end gap-8 max-sample:grid-cols-1',
  eyebrow:
    'mt-0 mb-[0.65rem] text-[0.78rem] font-extrabold tracking-[0.12em] text-[#147d58] uppercase',
  heroTitle:
  ...
  form: classes(
    ...
    'p-[clamp(1.5rem,4vw,2.5rem)] shadow-[0_20px_50px_rgb(23_68_45_/_6%)]',
  ),
  formHeader:
  ...
  resetButton: classes(
    ...
    'border-[#dbe9e0] text-[0.82rem] font-extrabold text-[#365947]',
  ...
  field: 'grid gap-2 font-bold text-[#15271f]',
  ...
  submitButton: classes(
    ...
    'font-extrabold text-white hover:bg-[#106b48] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#147d58] disabled:cursor-not-allowed disabled:opacity-[0.45]',
  ),
  result: 'grid gap-[0.4rem] rounded-[1rem] border border-[#b6dac7] bg-[#f0f9f3] p-4 text-[#154d32]',
  resultTitle: 'text-base',
  resultDetail: 'leading-normal text-[#41735a]',
  preparationError: classes('m-0', fieldError),
  versionSwitch:
    'mb-8 inline-flex gap-[0.35rem] rounded-full border border-sample-border bg-[#f0f9f3] p-[0.35rem]',
  versionButton:
    'inline-flex cursor-pointer items-center rounded-full border-0 px-[0.9rem] py-[0.65rem] text-[0.86rem] font-extrabold no-underline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#147d58]',
  activeVersionButton:
    'bg-sample-primary text-white shadow-[0_4px_12px_rgb(20_125_88_/_16%)]',
  inactiveVersionButton: 'bg-transparent text-[#52685c] hover:bg-[#e4f3ea] hover:text-[#106b48]',
  comparison: classes(
  ...
  comparisonTable:
    'grid divide-y divide-[#dbe9e0] overflow-hidden rounded-[1rem] border border-sample-border bg-white',
  comparisonRow:
    'grid grid-cols-[0.8fr_1fr_1fr] divide-x divide-[#dbe9e0] max-sample:grid-cols-[0.9fr_1fr_1fr]',
  comparisonCell: 'px-3 py-[0.65rem] text-[0.82rem]',
  comparisonHeaderCell: 'bg-[#f0f9f3] text-[#15271f]',
  comparisonBodyCell: 'text-[#52685c]',
  comparisonActiveCell: 'bg-[#e4f3ea] font-extrabold text-[#106b48]',
} as const
