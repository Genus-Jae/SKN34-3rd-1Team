...
export const partnerRecruitmentStyles = {
  ...
  cardFooterNote: 'flex flex-wrap items-center gap-[0.35rem] text-[0.72rem] text-[#5c6785]',
  ...
  detailAuthorCard: 'flex flex-wrap items-center justify-between gap-4 rounded-[0.7rem] bg-[#f7f8fc] px-4 py-[0.85rem]',
  detailAuthorAvatar:
  ...
  proposalSubmit: classes(
    ...
    'text-[0.9rem] font-extrabold text-white hover:bg-[#5051b8] disabled:cursor-not-allowed disabled:opacity-60',
  ),
  ...
  fieldControl: classes(
    ...
    'text-[0.95rem] font-normal text-[#17213d] placeholder:text-sample-muted',
    'focus:border-[#7774d7] focus:shadow-[0_0_0_3px_rgb(119_116_215_/_15%)] focus:outline-0',
  ),
  ...
  capabilityChip:
    'inline-flex min-w-0 max-w-full items-center gap-[0.3rem] rounded-full bg-[#f1f2ff] px-[0.65rem] py-[0.3rem] text-[0.75rem] font-bold text-[#504ebd] [overflow-wrap:anywhere]',
  capabilityRemove: 'shrink-0 cursor-pointer border-0 bg-transparent p-0 text-[0.75rem] leading-none text-[#504ebd]',
  capabilityInput:
    'min-w-32 flex-1 border-0 bg-transparent text-[0.85rem] text-[#17213d] placeholder:text-sample-muted focus:outline-0',
