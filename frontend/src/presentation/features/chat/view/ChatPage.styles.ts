...
// 채팅에만 적용하는 색상입니다. 계정·모집·상세 화면의 공통 테마는 바꾸지 않습니다.
const chatTheme = '[--color-brand-primary:#147d58] [--color-brand-accent:#c8ead8] [--color-app-ink:#15271f] [--color-sample-muted:#52685c]'
...
export const chatPageStyles = {
  ...
  page: `${chatTheme} min-h-screen bg-[linear-gradient(180deg,#f0f9f3_0%,#f9fdfb_65%,#fff_100%)] text-app-ink`,
  workspace:
  ...
  workspacePage: `${chatTheme} relative flex min-h-0 flex-1 flex-col bg-[#f4faf6] text-app-ink max-chat:min-h-svh`,
  ...
  programSourceLink:
    'rounded-[0.55rem] bg-[#edf7f1] px-[0.7rem] py-[0.55rem] text-[0.74rem] font-extrabold text-[#286044] no-underline',
} as const
