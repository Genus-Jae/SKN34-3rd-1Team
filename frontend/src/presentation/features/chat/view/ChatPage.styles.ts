...
export const chatPageStyles = {
  ...
  proposalTitle: 'm-0 text-sm font-bold leading-relaxed text-app-ink [overflow-wrap:anywhere]',
  ...
  searchingBubble: classes(
    ...
    'text-sample-muted shadow-[0_10px_30px_rgb(32_33_36_/_5%)]',
  ),
  intro: 'mx-auto w-[min(1180px,calc(100%_-_2rem))] pt-[clamp(2.5rem,5vw,4.5rem)] text-center',
  introBadge: 'inline-flex items-center gap-2 rounded-full bg-brand-accent px-4 py-2 text-[0.85rem] font-bold text-brand-primary',
